  ...
  return (
    <div>
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <p className="text-sm uppercase tracking-[0.16em] text-slate-500">Total earnings</p>
          <p className="mt-3 text-3xl font-semibold text-slate-900">₹ {totalEarnings.toLocaleString()}</p>
          <p className="mt-2 text-sm text-slate-500">Total fee collected from all patients.</p>
        </div>
